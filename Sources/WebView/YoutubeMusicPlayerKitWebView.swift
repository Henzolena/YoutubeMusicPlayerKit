...
// MARK: - YoutubeMusicPlayerKitWebView

/// A YouTube player web view.
final class YoutubeMusicPlayerKitWebView: WKWebView {
    
    // MARK: Properties
    
    /// The YoutubeMusicPlayerKit.
    private(set) weak var player: YoutubeMusicPlayerKit?
    ...
    /// Creates a new instance of `YoutubeMusicPlayerKitWebView`
...
private extension YoutubeMusicPlayerKitWebView {
    ...
    /// Setups the web view.
    func setup(
        using player: YoutubeMusicPlayerKit
    ) {
...
extension YoutubeMusicPlayerKitWebView {
    ...
    func load() throws {
        ...
        guard let player = self.player else {
            ...
            throw YoutubeMusicPlayerKit.APIError(
        ...
        do {
            ...
            let jsonEncodedPlayerOptionsString = try YoutubeMusicPlayerKit.Options(
