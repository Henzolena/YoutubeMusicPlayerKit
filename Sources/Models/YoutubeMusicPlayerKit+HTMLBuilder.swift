...
// MARK: - YoutubeMusicPlayerKit+HTMLBuilder
...
public extension YoutubeMusicPlayerKit {
    ...
    struct HTMLBuilder: Sendable {
        ...
        public typealias HTMLProvider = @Sendable (Self, YoutubeMusicPlayerKit.Options.JSONEncodedString) throws -> String
        ...
        /// Creates a new instance of ``YoutubeMusicPlayerKit/HTMLBuilder``
        /// - Parameters:
...
public extension YoutubeMusicPlayerKit.HTMLBuilder {
    
    /// Builds the HTML.
    /// - Parameter jsonEncodedPlayerOptionsString: The JSON encoded YouTube player options string.
    func callAsFunction(
        jsonEncodedPlayerOptionsString: YoutubeMusicPlayerKit.Options.JSONEncodedString
    ) throws -> String {
...
extension YoutubeMusicPlayerKit.HTMLBuilder: Equatable {
...
extension YoutubeMusicPlayerKit.HTMLBuilder: Hashable {
...
extension YoutubeMusicPlayerKit.HTMLBuilder: Codable {
...
public extension YoutubeMusicPlayerKit.HTMLBuilder {
    ...
    static func defaultHTMLProvider(
        excludedEventNames: Set<YoutubeMusicPlayerKit.Event.Name> = .init()
    ) -> HTMLProvider {
        { htmlBuilder, jsonEncodedPlayerOptionsString in
            ...
            <body>
                ...
                <script src="\(htmlBuilder.youTubePlayerIframeAPISourceURL)"
                    onerror="window.location.href='\(htmlBuilder.youTubePlayerEventCallbackURLScheme)://\(YoutubeMusicPlayerKit.Event.Name.iFrameApiFailedToLoad.rawValue)'">
                </script>
                ...
                <script>
                    ...
                    function onYouTubeIframeAPIReady() {
                        ...
                        sendYoutubeMusicPlayerKitEvent('\(YoutubeMusicPlayerKit.Event.Name.iFrameApiReady.rawValue)');
                    }
            
                    function sendYoutubeMusicPlayerKitEvent(eventName, event) {
                        ...
                        YoutubeMusicPlayerKit
                            ...
                            .map { eventName in
                                ...
                                function \(eventName)(event) {
                                    sendYoutubeMusicPlayerKitEvent('\(eventName)', event);
                                }
                                """
                            }
                            .joined(separator: "\n\n")
