...
// MARK: - YoutubeMusicPlayerKit+Configuration
...
public extension YoutubeMusicPlayerKit {
    ...
    struct Configuration: Hashable, Sendable {
        ...
        /// The fullscreen mode.
        /// - Important: Setting the fullscreen mode to ``YoutubeMusicPlayerKit/FullscreenMode/web`` does not guarantee
        ...
        /// Creates a new instance of ``YoutubeMusicPlayerKit/Configuration``
        /// - Parameters:
...
extension YoutubeMusicPlayerKit.Configuration: ExpressibleByURL {
    ...
    public init?(
        ...
        self.init(
            allowsInlineMediaPlayback: queryItems
                .first { $0.name == YoutubeMusicPlayerKit.Parameters.CodingKeys.playInline.rawValue }
...
extension YoutubeMusicPlayerKit.Configuration: Codable {
    ...
    public init(
        ...
        try self.init(
            fullscreenMode: container.decode(YoutubeMusicPlayerKit.FullscreenMode.self, forKey: .fullscreenMode),
            ...
            htmlBuilder: container.decode(YoutubeMusicPlayerKit.HTMLBuilder.self, forKey: .htmlBuilder),
