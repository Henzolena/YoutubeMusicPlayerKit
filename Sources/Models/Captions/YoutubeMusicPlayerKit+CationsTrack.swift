...
// MARK: - YoutubeMusicPlayerKit+CaptionsTrack
...
public extension YoutubeMusicPlayerKit {
    ...
    struct CaptionsTrack: Hashable, Sendable, Identifiable {
        ...
        /// Creates a new instance of ``YoutubeMusicPlayerKit/CaptionsTrack``
        /// - Parameters:
...
extension YoutubeMusicPlayerKit.CaptionsTrack: Codable {
