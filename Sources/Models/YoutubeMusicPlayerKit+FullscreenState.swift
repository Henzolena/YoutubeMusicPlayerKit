...
public extension YoutubeMusicPlayerKit {
    ...
    struct FullscreenState: Hashable, Sendable {
        ...
        /// Creates a new instance of ``YoutubeMusicPlayerKit/FullscreenState``
        /// - Parameters:
...
extension YoutubeMusicPlayerKit.FullscreenState: Codable {
...
extension YoutubeMusicPlayerKit.FullscreenState: ExpressibleByBooleanLiteral {
