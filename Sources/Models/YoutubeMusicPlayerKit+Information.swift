...
// MARK: - YoutubeMusicPlayerKit+Information
...
public extension YoutubeMusicPlayerKit {
    ...
    struct Information: Codable, Hashable, Sendable {
        ...
        public let playerState: YoutubeMusicPlayerKit.PlaybackState
        
        /// The YouTube player playback rate.
        public let playbackRate: YoutubeMusicPlayerKit.PlaybackRate
        
        /// The available YouTube player playback rates.
        public let availablePlaybackRates: [YoutubeMusicPlayerKit.PlaybackRate]
        
        /// The YouTube player playback quality.
        public let playbackQuality: YoutubeMusicPlayerKit.PlaybackQuality
        
        /// The available YouTube player playback qualities.
        public let availableQualityLevels: [YoutubeMusicPlayerKit.PlaybackQuality]
        ...
        public let videoData: YoutubeMusicPlayerKit.PlaybackMetadata
        
        // MARK: Initializer
        
        /// Creates a new instance of ``YoutubeMusicPlayerKit/Information``
        /// - Parameters:
        ...
        public init(
            ...
            muted: Bool,
            volume: Int,
            playerState: YoutubeMusicPlayerKit.PlaybackState,
            playbackRate: YoutubeMusicPlayerKit.PlaybackRate,
            availablePlaybackRates: [YoutubeMusicPlayerKit.PlaybackRate],
            playbackQuality: YoutubeMusicPlayerKit.PlaybackQuality,
            availableQualityLevels: [YoutubeMusicPlayerKit.PlaybackQuality],
            currentTime: Double,
            duration: Double,
            videoEmbedCode: String,
            videoUrl: String,
            mediaReferenceTime: Double,
            videoData: YoutubeMusicPlayerKit.PlaybackMetadata
        ) {
