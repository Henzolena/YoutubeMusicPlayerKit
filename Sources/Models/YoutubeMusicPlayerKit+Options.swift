...
// MARK: - YoutubeMusicPlayerKit+Options
...
public extension YoutubeMusicPlayerKit {
    ...
    struct Options: Hashable, Sendable {
        ...
        /// The source.
        public var source: YoutubeMusicPlayerKit.Source?
        
        /// The parameters.
        public var parameters: YoutubeMusicPlayerKit.Parameters
        
        // MARK: Initializer
        
        /// Creates a new instance of ``YoutubeMusicPlayerKit/Options``
        /// - Parameters:
        ///   - source: The source. Default value `nil`
        ///   - parameters: The parameters.
        public init(
            source: YoutubeMusicPlayerKit.Source? = nil,
            parameters: YoutubeMusicPlayerKit.Parameters
        ) {
            self.source = source
...
extension YoutubeMusicPlayerKit.Options: EncodableWithConfiguration {
    ...
    public struct EncodingConfiguration: Codable, Hashable, Sendable {
        ...
        /// Creates a new instance of ``YoutubeMusicPlayerKit/Options/EncodingConfiguration``
...
public extension YoutubeMusicPlayerKit.Options {
    
    /// A JSON encoded string representation of the ``YoutubeMusicPlayerKit/Options``.
    ...
    func jsonEncode(
        ...
        if #available(iOS 17.0, macOS 14.0, visionOS 1.0, *) {
            ...
            struct EncodingContainer: Encodable {
                ...
                let options: YoutubeMusicPlayerKit.Options
                
                /// The JavaScript player options encoding configuration.
                let encodingConfiguration: YoutubeMusicPlayerKit.Options.EncodingConfiguration
