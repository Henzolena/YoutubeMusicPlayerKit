...
public extension YoutubeMusicPlayerKitView where Overlay == EmptyView {
...
public extension YoutubeMusicPlayerKitView {
...
public extension YoutubeMusicPlayerKitView {
    ...
    init<IdleOverlay: View, ReadyOverlay: View, ErrorOverlay: View>(
        ...
        @ViewBuilder
        errorOverlay: @escaping (YoutubeMusicPlayerKit.Error) -> ErrorOverlay
